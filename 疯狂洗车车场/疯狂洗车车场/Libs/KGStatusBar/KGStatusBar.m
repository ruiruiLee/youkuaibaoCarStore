...
+ (void)showWithStatus:(NSString*)status {
    [[KGStatusBar sharedView] showWithStatus:status barColor:[UIColor colorWithRed:235.0/255.0 green:84/255.0 blue:1/255.0 alpha:1.0] textColor:[UIColor whiteColor]];
}
