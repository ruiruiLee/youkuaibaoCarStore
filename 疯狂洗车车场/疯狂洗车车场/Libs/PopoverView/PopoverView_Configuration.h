...
#define kGradientBottomColor [UIColor colorWithRed:0 green:0 blue:0 alpha:kBoxAlpha]
...
#define kGradientTitleBottomColor [UIColor colorWithRed:0.93f green:0.93f blue:0.75f alpha:kBoxAlpha]
...
//[UIColor colorWithRed:0.329 green:0.341 blue:0.353 alpha:1]  old
// highlighted text color
#define kTextHighlightColor [UIColor colorWithRed:22/255.0 green:162/255.0 blue:213/255.0 alpha:1]

//normal text alignment
#define kTextAlignment UITextAlignmentCenter

//title font
#define kTitleFont [UIFont fontWithName:@"HelveticaNeue-Bold" size:18.f]

//title text color
#define kTitleColor [UIColor colorWithRed:22/255.0 green:162/255.0 blue:213/255.0 alpha:1]
//[UIColor colorWithRed:0.329 green:0.341 blue:0.353 alpha:1] old
